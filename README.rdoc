= Redmine Time Tracker plugin for Redmine >= 2.1 only!!!
...
This is a fork of the original version in order to work with the new unobtrusive javascript
in Rails 3. Full credit for original version goes to Jérémie Delaitre.

Credit for the port goes to mohikaner. The original fork is located at {GitHub}[http://github.com/mohikaner/redmine_time_tracker].
...
The newest version is always at {GitHub}[http://github.com/seeraven/redmine_time_tracker].
